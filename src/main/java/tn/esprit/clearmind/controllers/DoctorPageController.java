            ...
            try {
                ...
                if (result.next()) {
                    ...
                    if (result.next()) {
                        ...
                        Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/clearmind/DoctorMainForm.fxml"));
    ...
    public void switchPage() {
        ...
        if (login_user.getSelectionModel().getSelectedItem() == "Admin Portal") {
            ...
            try {
                ...
                Parent root = FXMLLoader.load(getClass().getResource("/tn/esprit/clearmind/DoctorForm.fxml"));
                Stage stage = new Stage();
